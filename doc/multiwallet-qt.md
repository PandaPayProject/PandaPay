...
Only requiring some minor changes is pandapay.cpp.
...
Changes to pandapay.cpp
----------------------
pandapay.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
