...
This mechanism has been integrated into Bitcore-Node-PandaPay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PandaPayProject/insight-api-pandapay#web-socket-api](https://github.com/PandaPayProject/insight-api-pandapay#web-socket-api) 
* API: [https://github.com/PandaPayProject/insight-api-pandapay#instantsend-transactions](https://github.com/PandaPayProject/insight-api-pandapay#instantsend-transactions) 
...
By default, the PandaPay Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PandaPay Core daemon:
