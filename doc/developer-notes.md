...
PandaPay Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as PandaPay Core, where everyone uses
...
pay attention to for reviewers of PandaPay Core code.

General PandaPay Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: PandaPay Core uses tinyformat, which is type safe. Leave them out to avoid confusion
