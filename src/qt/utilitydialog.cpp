    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("PandaPay Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About PandaPay Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pandapay-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the PandaPay in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PANDA, 0.1 PANDA, 1 PANDA and 10 PANDA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://pandapay.atlassian.net/wiki/display/DOC/PrivateSend\">https://pandapay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("PandaPay Core is shutting down...") + "<br /><br />" +
