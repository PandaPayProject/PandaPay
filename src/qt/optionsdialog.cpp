    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PANDA-light"), QVariant("light"));
    ui->theme->addItem(QString("PANDA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PANDA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PANDA-traditional"), QVariant("trad"));
