    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("PandaPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PandaPay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pandapay: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About PandaPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about PandaPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PandaPay Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PandaPay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PandaPay addresses"));
    ...
    openAction->setStatusTip(tr("Open a pandapay: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PandaPay Core help message to get a list with possible PandaPay Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PandaPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PandaPay network", "", count));
}
...
{
    QString strTitle = tr("PandaPay Core"); // default title
