...
{
public:
    /// Is the input associated with this public key? (and there is 262500 PANDA - checking if valid masternode)
...
private:
    ...
    /// Get the denominations for a specific amount of pandapay.
