...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("PandaPay Core pandapay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pandapay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pandapay transaction") + "\n" +
              "  pandapay-tx [options] -create [commands]   " + _("Create hex-encoded pandapay transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pandapay transaction
