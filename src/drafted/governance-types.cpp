...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PandaPayNetwork") type = PandaPayNetwork;
    if(strType == "PandaPayNetworkVariable") type = PandaPayNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PandaPayNetwork) s = "PandaPayNetwork";
    if(type == PandaPayNetworkVariable) s = "PandaPayNetworkVariable";
