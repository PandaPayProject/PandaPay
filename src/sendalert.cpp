...
2. run pandapayd with -printalert or -sendalert like this:
   /path/to/pandapayd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.pandapay.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/PandaPay Core:0.12.0.58/"));
